...
mod test {
    ...
    fn test_fw_manifest_dot_unlock() {
        ...
        let manifest =
            create_manifest_section(&[FW_MANIFEST_DOT_CMD_UNLOCK], 0, [0u32; 12], [0u32; 12]);
    ...
    fn test_fw_manifest_dot_no_magic_skipped() {
        ...
        // The no-magic test doesn't write any manifest to SRAM.
        // Whatever firmware bytes are at SRAM[0..4] won't match the DOT magic,
        // so manifest processing is silently skipped.
