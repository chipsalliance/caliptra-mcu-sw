...
pub mod test {
    ...
    impl RequestResponseTest {
        ...
        fn aes_gcm_encrypt(
            ...
            // Use a conservative split size to ensure total request fits within 4K SRAM
            // Request includes headers (~140 bytes) plus plaintext data
            let split = 2048;
        ...
        fn aes_gcm_decrypt(
            ...
            // Use a conservative split size to ensure total request fits within 4K SRAM
            // Request includes headers (~140 bytes) plus ciphertext data
            let split = 2048;
