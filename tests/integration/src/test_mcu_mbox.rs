...
pub mod test {
    ...
    impl RequestResponseTest {
        ...
        /// Aligned with caliptra-sw runtime tests using rustcrypto_ecdsa for verification.
        ...
        fn add_ecdsa_tests(&mut self) -> Result<(), ()> {
            ...
            for i in 0..10 {
                ...
                let verify_result = self.ecdsa_verify(&cmk, &data, &signature.0, &signature.1)?;
                assert!(
                    verify_result,
        ...
        /// Test HMAC command with SHA384 and SHA512.
