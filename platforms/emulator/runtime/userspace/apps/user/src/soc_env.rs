...
pub const NUM_DEFAULT_FW_COMPONENTS: usize = 2;
...
// const CALIPTRA_FW_AUTH_MAN_ID: &str = "SOC_MANIFEST"; // Commented out - non-deterministic signatures
pub const DEFAULT_FW_IDS: [&str; NUM_DEFAULT_FW_COMPONENTS] = [
    CALIPTRA_FW_FMC_OID,
    CALIPTRA_FW_RT_OID,
    // CALIPTRA_FW_AUTH_MAN_ID, // Commented out - non-deterministic signatures
];
