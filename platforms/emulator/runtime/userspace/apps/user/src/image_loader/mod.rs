...
pub async fn image_loading_task() {
    ...
    ))]
    {
        ...
        #[cfg(any(feature = "test-firmware-update-streaming", feature = "test-firmware-update-flash"))]
        {
...
async fn image_loading() -> Result<(), ErrorCode> {
    ...
    #[cfg(any(feature = "test-flash-based-boot",feature = "test-firmware-update-flash",))]
    {
