...
pub const SOC_ADDR: u32 = 0xa003_0000;
pub mod bits {
...
pub mod regs {
    ...
    register_structs! {
        pub Soc {
            ...
            (0x174 => _reserved1),
            (0x200 => pub fuse_uds_seed: [tock_registers::registers::ReadWrite<u32>; 16]),
            (0x240 => pub fuse_field_entropy: [tock_registers::registers::ReadWrite<u32>; 8]),
            ...
            (0x530 => pub ss_debug_intent: tock_registers::registers::ReadWrite<u32, crate::soc::bits::SsDebugIntent::Register>),
            ...
            (0x5e0 => _reserved7),
            (0x600 => pub internal_obf_key: [tock_registers::registers::ReadWrite<u32>; 8]),
