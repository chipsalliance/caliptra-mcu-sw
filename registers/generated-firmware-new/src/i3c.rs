...
pub const I3C_ADDR: u32 = 0x2000_4000;

// Memory regions
pub const DAT_OFFSET: u32 = 0x400;
pub const DAT_SIZE: usize = 0x400;
pub const DAT_PTR: *mut u8 = 0x2000_4400 as *mut u8;
pub const DCT_OFFSET: u32 = 0x800;
pub const DCT_SIZE: usize = 0x800;
...
pub mod regs {
    ...
    register_structs! {
        pub I3c {
            ...
            (0x68 => pub i3c_base_dev_ctx_sg: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DevCtxSg::Register>),
            (0x6c => _reserved3),
            ...
            (0x88 => pub piocontrol_tx_data_port: tock_registers::registers::ReadWrite<u32>),
            ...
            (0xb4 => _reserved4),
            (0x100 => pub sec_fw_recovery_if_extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::ExtcapHeader::Register>),
            ...
            (0x1cc => pub tti_reset_control: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::ResetControl::Register>),
            ...
            (0x1f0 => pub tti_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::QueueSize::Register>),
            (0x1f4 => pub tti_ibi_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::IbiQueueSize::Register>),
            (0x1f8 => pub tti_queue_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::QueueThldCtrl::Register>),
            (0x1fc => pub tti_data_buffer_thld_ctrl: tock_registers::registers::ReadWrite<u32, crate::i3c::bits::DataBufferThldCtrl::Register>),
            ...
            (0x268 => pub i3c_ec_termination_extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c::bits::TerminationExtcapHeader::Register>),
            (0x26c => @END),
        }
    }
}
