...
pub const LC_ADDR: u32 = 0x7000_0400;
pub mod bits {
...
pub mod regs {
    ...
    register_structs! {
        pub Lc {
            (0x0 => pub alert_test: tock_registers::registers::WriteOnly<u32, crate::lc::bits::AlertTest::Register>),
            (0x4 => pub status: tock_registers::registers::ReadOnly<u32, crate::lc::bits::Status::Register>),
            (0x8 => pub claim_transition_if_regwen: tock_registers::registers::ReadWrite<u32, crate::lc::bits::ClaimTransitionIfRegwen::Register>),
            (0xc => pub claim_transition_if: tock_registers::registers::ReadWrite<u32, crate::lc::bits::ClaimTransitionIf::Register>),
            (0x10 => pub transition_regwen: tock_registers::registers::ReadOnly<u32, crate::lc::bits::TransitionRegwen::Register>),
            (0x14 => pub transition_cmd: tock_registers::registers::ReadWrite<u32, crate::lc::bits::TransitionCmd::Register>),
            (0x18 => pub transition_ctrl: tock_registers::registers::ReadWrite<u32, crate::lc::bits::TransitionCtrl::Register>),
            ...
            (0x2c => pub transition_target: tock_registers::registers::ReadWrite<u32, crate::lc::bits::TransitionTarget::Register>),
            ...
            (0x38 => pub lc_state: tock_registers::registers::ReadOnly<u32, crate::lc::bits::LcState::Register>),
            (0x3c => pub lc_transition_cnt: tock_registers::registers::ReadOnly<u32, crate::lc::bits::LcTransitionCnt::Register>),
            (0x40 => pub lc_id_state: tock_registers::registers::ReadOnly<u32>),
            (0x44 => pub hw_revision0: tock_registers::registers::ReadOnly<u32, crate::lc::bits::HwRevision0::Register>),
            (0x48 => pub hw_revision1: tock_registers::registers::ReadOnly<u32, crate::lc::bits::HwRevision1::Register>),
