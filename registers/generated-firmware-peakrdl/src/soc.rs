...
pub const SOC_IFC_ADDR: u32 = 0xa003_0000;
pub mod bits {
    ...
    register_bitfields! {
        ...
        pub CptraMboxAxiUserLock [
            Lock OFFSET(0) NUMBITS(1) [],
        ],
        pub CptraOwnerPkHashLock [
            Lock OFFSET(0) NUMBITS(1) [],
        ],
...
pub mod regs {
    ...
    register_structs! {
        pub SocIfc {
            ...
            (0x5c => pub cptra_mbox_axi_user_lock: [tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraMboxAxiUserLock::Register>; 5]),
            (0x70 => pub cptra_trng_valid_axi_user: tock_registers::registers::ReadWrite<u32>),
            (0x74 => pub cptra_trng_axi_user_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraTrngAxiUserLock::Register>),
            (0x78 => pub cptra_trng_data: [tock_registers::registers::ReadWrite<u32>; 12]),
            (0xa8 => pub cptra_trng_ctrl: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraTrng::Register>),
            ...
            (0xe8 => pub cptra_wdt_timer1_ctrl: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraWdtTimer1::Register>),
            ...
            (0xf8 => pub cptra_wdt_timer2_ctrl: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraWdtTimer2::Register>),
            ...
            (0x10c => pub cptra_fuse_axi_user_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraFuseAxiUserLock::Register>),
            ...
            (0x130 => pub cptra_cap_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraCapLock::Register>),
            (0x134 => _reserved0),
            (0x140 => pub cptra_owner_pk_hash: [tock_registers::registers::ReadWrite<u32>; 12]),
            (0x170 => pub cptra_owner_pk_hash_lock: tock_registers::registers::ReadWrite<u32, crate::soc::bits::CptraOwnerPkHashLock::Register>),
            (0x174 => _reserved1),
            ...
            (0x650 => _reserved8),
            (0x800 => pub intr_block_rfglobal_intr_en_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::GlobalIntrEnT::Register>),
            (0x804 => pub intr_block_rferror_intr_en_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::ErrorIntrEnT::Register>),
            (0x808 => pub intr_block_rfnotif_intr_en_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::NotifIntrEnT::Register>),
            (0x80c => pub intr_block_rferror_global_intr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::GlobalIntrT::Register>),
            (0x810 => pub intr_block_rfnotif_global_intr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::GlobalIntrT::Register>),
            (0x814 => pub intr_block_rferror_internal_intr_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::ErrorIntrT::Register>),
            (0x818 => pub intr_block_rfnotif_internal_intr_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::NotifIntrT::Register>),
            (0x81c => pub intr_block_rferror_intr_trig_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::ErrorIntrTrigT::Register>),
            (0x820 => pub intr_block_rfnotif_intr_trig_r: tock_registers::registers::ReadWrite<u32, crate::soc::bits::NotifIntrTrigT::Register>),
            (0x824 => _reserved9),
            (0x900 => pub intr_block_rferror_internal_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x904 => pub intr_block_rferror_inv_dev_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x908 => pub intr_block_rferror_cmd_fail_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x90c => pub intr_block_rferror_bad_fuse_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x910 => pub intr_block_rferror_iccm_blocked_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x914 => pub intr_block_rferror_mbox_ecc_unc_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x918 => pub intr_block_rferror_wdt_timer1_timeout_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x91c => pub intr_block_rferror_wdt_timer2_timeout_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x920 => _reserved10),
            (0x980 => pub intr_block_rfnotif_cmd_avail_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x984 => pub intr_block_rfnotif_mbox_ecc_cor_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x988 => pub intr_block_rfnotif_debug_locked_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x98c => pub intr_block_rfnotif_scan_mode_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x990 => pub intr_block_rfnotif_soc_req_lock_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x994 => pub intr_block_rfnotif_gen_in_toggle_intr_count_r: tock_registers::registers::ReadWrite<u32>),
            (0x998 => _reserved11),
            (0xa00 => pub intr_block_rferror_internal_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa04 => pub intr_block_rferror_inv_dev_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa08 => pub intr_block_rferror_cmd_fail_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa0c => pub intr_block_rferror_bad_fuse_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa10 => pub intr_block_rferror_iccm_blocked_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa14 => pub intr_block_rferror_mbox_ecc_unc_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa18 => pub intr_block_rferror_wdt_timer1_timeout_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa1c => pub intr_block_rferror_wdt_timer2_timeout_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa20 => pub intr_block_rfnotif_cmd_avail_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa24 => pub intr_block_rfnotif_mbox_ecc_cor_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa28 => pub intr_block_rfnotif_debug_locked_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa2c => pub intr_block_rfnotif_scan_mode_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa30 => pub intr_block_rfnotif_soc_req_lock_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa34 => pub intr_block_rfnotif_gen_in_toggle_intr_count_incr_r: tock_registers::registers::ReadOnly<u32, crate::soc::bits::IntrCountIncrT::Register>),
            (0xa38 => @END),
        }
    }
}
