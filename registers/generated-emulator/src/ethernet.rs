...
pub trait EthernetPeripheral {
    ...
    fn read_eth_status(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthStatus::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_eth_tx_len(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthTxLen::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_eth_rx_len(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthRxLen::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_eth_tx_ptr(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthTxPtr::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_eth_rx_ptr(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthRxPtr::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_eth_mac_high(
        ...
        u32,
        caliptra_mcu_registers_generated::ethernet::bits::EthMacHigh::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
