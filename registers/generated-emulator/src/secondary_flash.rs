...
pub trait SecondaryFlashPeripheral {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
                "[EMU] Non-functional register stub: read secondary_flash::fl_interrupt_state"
            );
        }
    ...
    fn write_fl_interrupt_state(
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln ! ("[EMU] Non-functional register stub: write secondary_flash::fl_interrupt_state = 0x{:08x}" , val . reg . get ());
        }
        if let Some(generated) = self.generated() {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
                "[EMU] Non-functional register stub: read secondary_flash::fl_interrupt_enable"
            );
        }
        if let Some(generated) = self.generated() {
    ...
    fn write_fl_interrupt_enable(
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln ! ("[EMU] Non-functional register stub: write secondary_flash::fl_interrupt_enable = 0x{:08x}" , val . reg . get ());
        }
        if let Some(generated) = self.generated() {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!("[EMU] Non-functional register stub: read secondary_flash::fl_control");
        }
        if let Some(generated) = self.generated() {
    ...
    fn write_fl_control(
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
                "[EMU] Non-functional register stub: write secondary_flash::fl_control = 0x{:08x}",
                val.reg.get()
            );
        }
        if let Some(generated) = self.generated() {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!("[EMU] Non-functional register stub: read secondary_flash::op_status");
        }
        if let Some(generated) = self.generated() {
    ...
    fn write_op_status(
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
                "[EMU] Non-functional register stub: write secondary_flash::op_status = 0x{:08x}",
                val.reg.get()
            );
        }
        if let Some(generated) = self.generated() {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!("[EMU] Non-functional register stub: read secondary_flash::ctrl_regwen");
        }
        if let Some(generated) = self.generated() {
