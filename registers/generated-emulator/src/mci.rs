...
pub trait MciPeripheral {
    ...
    fn read_mci_reg_cap_lock(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::CapLock::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_hw_config0(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::HwConfig0::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_hw_config1(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::HwConfig1::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_hw_flow_status(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::HwFlowStatus::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_reset_reason(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::ResetReason::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_reset_status(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::ResetStatus::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_security_state(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::SecurityState::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_hw_error_fatal(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::HwErrorFatal::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_agg_error_fatal(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::AggErrorFatal::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_hw_error_non_fatal(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::HwErrorNonFatal::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_agg_error_non_fatal(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::AggErrorNonFatal::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_internal_hw_error_fatal_mask(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::InternalHwErrorFatalMask::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_internal_hw_error_non_fatal_mask(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::InternalHwErrorNonFatalMask::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_internal_agg_error_fatal_mask(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::InternalAggErrorFatalMask::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_internal_agg_error_non_fatal_mask(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::InternalAggErrorNonFatalMask::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_wdt_timer1_en(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::WdtTimer1En::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_wdt_timer1_ctrl(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::WdtTimer1Ctrl::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_wdt_timer2_en(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::WdtTimer2En::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_wdt_timer2_ctrl(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::WdtTimer2Ctrl::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_wdt_status(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::WdtStatus::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_fw_sram_exec_region_size(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::FwSramExecRegionSize::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
    ...
    fn read_mci_reg_mbox0_axi_user_lock(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::MboxxAxiUserLock::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
    ...
    fn read_mci_reg_ss_debug_intent(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::SsDebugIntent::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_ss_debug_intent_mcu(
        &mut self,
    ) -> caliptra_emu_bus::ReadWriteRegister<
        u32,
        caliptra_mcu_registers_generated::mci::bits::SsDebugIntentMcu::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!("[EMU] Non-functional register stub: read mci::mci_reg_ss_debug_intent_mcu");
        }
        if let Some(generated) = self.generated() {
            return generated.read_mci_reg_ss_debug_intent_mcu();
        }
        caliptra_emu_bus::ReadWriteRegister::new(0)
    }
    fn write_mci_reg_ss_debug_intent_mcu(
        &mut self,
        val: caliptra_emu_bus::ReadWriteRegister<
            u32,
            caliptra_mcu_registers_generated::mci::bits::SsDebugIntentMcu::Register,
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln ! ("[EMU] Non-functional register stub: write mci::mci_reg_ss_debug_intent_mcu = 0x{:08x}" , val . reg . get ());
        }
        if let Some(generated) = self.generated() {
            generated.write_mci_reg_ss_debug_intent_mcu(val);
        }
    }
    fn read_mci_reg_ss_config_done_sticky(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::SsConfigDone::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
    ...
    fn read_mci_reg_intr_block_rf_error1_intr_en_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Error1IntrEnT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_notif1_intr_en_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Notif1IntrEnT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_error_global_intr_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::GlobalIntrT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_error1_internal_intr_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Error1IntrT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_notif1_internal_intr_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Notif1IntrT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_error1_intr_trig_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Error1IntrTrigT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_notif1_intr_trig_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Notif1IntrTrigT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mci_reg_intr_block_rf_error_internal_intr_count_incr_r(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::IntrCountIncrT::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
    ...
    fn read_mcu_trace_buffer_csr_status(
        ...
        u32,
        caliptra_mcu_registers_generated::mci::bits::Status::Register,
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
...
pub struct MciGenerated {
    ...
    mci_reg_ss_debug_intent_mcu: caliptra_emu_types::RvData,
...
impl Default for MciGenerated {
    fn default() -> Self {
        Self {
            ...
            mci_reg_hw_rev_id: 0x2100 as caliptra_emu_types::RvData,
            ...
            mci_reg_ss_debug_intent_mcu: 0 as caliptra_emu_types::RvData,
...
impl MciPeripheral for MciGenerated {
    ...
    > {
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln!(
                "[EMU] Generated default register handler: read mci::mci_reg_ss_debug_intent_mcu"
            );
        }
        caliptra_emu_bus::ReadWriteRegister::new(self.mci_reg_ss_debug_intent_mcu)
    }
    fn write_mci_reg_ss_debug_intent_mcu(
        &mut self,
        val: caliptra_emu_bus::ReadWriteRegister<
        ...
        if crate::stub_warnings::stub_warnings_enabled() {
            eprintln ! ("[EMU] Generated default register handler: write mci::mci_reg_ss_debug_intent_mcu = 0x{:08x}" , val . reg . get ());
        }
        let write_val = (val.reg.get()) as caliptra_emu_types::RvData;
        let current_val = self.mci_reg_ss_debug_intent_mcu;
        let mut new_val = current_val;
        let bits_to_set_0 = write_val & (1 as caliptra_emu_types::RvData);
        new_val |= bits_to_set_0;
        self.mci_reg_ss_debug_intent_mcu = new_val;
    }
    fn read_mci_reg_ss_config_done_sticky(
        &mut self,
    ) -> caliptra_emu_bus::ReadWriteRegister<
...
impl caliptra_emu_bus::Bus for MciBus {
    fn read(
        ...
        match addr {
            ...
            0x41c..0x420 => Ok(caliptra_emu_types::RvData::from(
                self.periph.read_mci_reg_ss_debug_intent_mcu().reg.get(),
            )),
    ...
    fn write(
        ...
        match addr {
            ...
            0x418..0x41c => Ok(()),
            0x41c..0x420 => {
                self.periph.write_mci_reg_ss_debug_intent_mcu(
                    caliptra_emu_bus::ReadWriteRegister::new(val),
                );
                Ok(())
            }
