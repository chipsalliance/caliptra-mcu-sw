...
pub mod regs {
    ...
    register_structs! {
        pub I3cCtrl {
            ...
            (0x6c => _reserved3),
            (0x0 => pub command_port: tock_registers::registers::ReadOnly<u32>),
            (0x4 => pub response_port: tock_registers::registers::ReadOnly<u32>),
            (0x8 => pub tx_data_port: tock_registers::registers::ReadOnly<u32>),
            (0xc => _reserved4),
            (0x8 => pub rx_data_port: tock_registers::registers::ReadOnly<u32>),
            (0xc => pub ibi_port: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::IbiPort::Register>),
            (0x10 => pub queue_thld_ctrl: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::QueueThldCtrl::Register>),
            (0x14 => pub data_buffer_thld_ctrl: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::DataBufferThldCtrl::Register>),
            (0x18 => pub queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::QueueSize::Register>),
            (0x1c => pub alt_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::AltQueueSize::Register>),
            (0x20 => pub pio_intr_status: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::PioIntrStatus::Register>),
            (0x24 => pub pio_intr_status_enable: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::PioIntrStatusEnable::Register>),
            (0x28 => pub pio_intr_signal_enable: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::PioIntrSignalEnable::Register>),
            (0x2c => pub pio_intr_force: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::PioIntrForce::Register>),
            (0x30 => pub pio_control: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::PioControl::Register>),
            (0x34 => _reserved5),
            (0x0 => pub termination_extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => _reserved6),
            (0x0 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => pub prot_cap_0: tock_registers::registers::ReadOnly<u32>),
            (0x8 => pub prot_cap_1: tock_registers::registers::ReadOnly<u32>),
            (0xc => pub prot_cap_2: tock_registers::registers::ReadOnly<u32>),
            (0x10 => pub prot_cap_3: tock_registers::registers::ReadOnly<u32>),
            (0x14 => pub device_id_0: tock_registers::registers::ReadOnly<u32>),
            (0x18 => pub device_id_1: tock_registers::registers::ReadOnly<u32>),
            (0x1c => pub device_id_2: tock_registers::registers::ReadOnly<u32>),
            (0x20 => pub device_id_3: tock_registers::registers::ReadOnly<u32>),
            (0x24 => pub device_id_4: tock_registers::registers::ReadOnly<u32>),
            (0x28 => pub device_id_5: tock_registers::registers::ReadOnly<u32>),
            (0x2c => pub device_id_6: tock_registers::registers::ReadOnly<u32>),
            (0x30 => pub device_status_0: tock_registers::registers::ReadOnly<u32>),
            (0x34 => pub device_status_1: tock_registers::registers::ReadOnly<u32>),
            (0x38 => pub device_reset: tock_registers::registers::ReadOnly<u32>),
            (0x3c => pub recovery_ctrl: tock_registers::registers::ReadOnly<u32>),
            (0x40 => pub recovery_status: tock_registers::registers::ReadOnly<u32>),
            (0x44 => pub hw_status: tock_registers::registers::ReadOnly<u32>),
            (0x48 => pub indirect_fifo_ctrl_0: tock_registers::registers::ReadOnly<u32>),
            (0x4c => pub indirect_fifo_ctrl_1: tock_registers::registers::ReadOnly<u32>),
            (0x50 => pub indirect_fifo_status_0: tock_registers::registers::ReadOnly<u32>),
            (0x54 => pub indirect_fifo_status_1: tock_registers::registers::ReadOnly<u32>),
            (0x58 => pub indirect_fifo_status_2: tock_registers::registers::ReadOnly<u32>),
            (0x5c => pub indirect_fifo_status_3: tock_registers::registers::ReadOnly<u32>),
            (0x60 => pub indirect_fifo_status_4: tock_registers::registers::ReadOnly<u32>),
            (0x64 => pub indirect_fifo_status_5: tock_registers::registers::ReadOnly<u32>),
            (0x68 => pub indirect_fifo_data: tock_registers::registers::ReadOnly<u32>),
            (0x6c => _reserved7),
            (0x0 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => pub stby_cr_control: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrControl::Register>),
            (0x8 => pub stby_cr_device_addr: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrDeviceAddr::Register>),
            (0xc => pub stby_cr_capabilities: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrCapabilities::Register>),
            (0x10 => pub _rsvd_0: tock_registers::registers::ReadOnly<u32>),
            (0x14 => pub stby_cr_status: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrStatus::Register>),
            (0x18 => pub stby_cr_device_char: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrDeviceChar::Register>),
            (0x1c => pub stby_cr_device_pid_lo: tock_registers::registers::ReadOnly<u32>),
            (0x20 => pub stby_cr_intr_status: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrIntrStatus::Register>),
            (0x24 => pub _rsvd_1: tock_registers::registers::ReadOnly<u32>),
            (0x28 => pub stby_cr_intr_signal_enable: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrIntrSignalEnable::Register>),
            (0x2c => pub stby_cr_intr_force: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrIntrForce::Register>),
            (0x30 => pub stby_cr_ccc_config_getcaps: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrCccConfigGetcaps::Register>),
            (0x34 => pub stby_cr_ccc_config_rstact_params: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::StbyCrCccConfigRstactParams::Register>),
            (0x38 => pub _rsvd_2: tock_registers::registers::ReadOnly<u32>),
            (0x3c => pub _rsvd_3: tock_registers::registers::ReadOnly<u32>),
            (0x40 => _reserved8),
            (0x0 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => pub control: tock_registers::registers::ReadOnly<u32>),
            (0x8 => pub status: tock_registers::registers::ReadOnly<u32>),
            (0xc => pub tti_reset_control: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TtiResetControl::Register>),
            (0x10 => pub interrupt_status: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::InterruptStatus::Register>),
            (0x14 => pub interrupt_enable: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::InterruptEnable::Register>),
            (0x18 => pub interrupt_force: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::InterruptForce::Register>),
            (0x1c => pub rx_desc_queue_port: tock_registers::registers::ReadOnly<u32>),
            (0x20 => pub rx_data_port: tock_registers::registers::ReadOnly<u32>),
            (0x24 => pub tx_desc_queue_port: tock_registers::registers::ReadOnly<u32>),
            (0x28 => pub tx_data_port: tock_registers::registers::ReadOnly<u32>),
            (0x2c => pub tti_ibi_port: tock_registers::registers::ReadOnly<u32>),
            (0x30 => pub tti_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TtiQueueSize::Register>),
            (0x34 => pub ibi_tti_queue_size: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::IbiTtiQueueSize::Register>),
            (0x38 => pub tti_queue_thld_ctrl: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TtiQueueThldCtrl::Register>),
            (0x3c => pub tti_data_buffer_thld_ctrl: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TtiDataBufferThldCtrl::Register>),
            (0x40 => _reserved9),
            (0x0 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => pub soc_mgmt_control: tock_registers::registers::ReadOnly<u32>),
            (0x8 => pub soc_mgmt_status: tock_registers::registers::ReadOnly<u32>),
            (0xc => pub soc_mgmt_rsvd_0: tock_registers::registers::ReadOnly<u32>),
            (0x10 => pub soc_mgmt_rsvd_1: tock_registers::registers::ReadOnly<u32>),
            (0x14 => pub soc_mgmt_rsvd_2: tock_registers::registers::ReadOnly<u32>),
            (0x18 => pub soc_mgmt_rsvd_3: tock_registers::registers::ReadOnly<u32>),
            (0x1c => pub soc_pad_conf: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::SocPadConf::Register>),
            (0x20 => pub soc_pad_attr: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::SocPadAttr::Register>),
            (0x24 => pub soc_mgmt_feature_2: tock_registers::registers::ReadOnly<u32>),
            (0x28 => pub soc_mgmt_feature_3: tock_registers::registers::ReadOnly<u32>),
            (0x2c => pub t_r_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TRReg::Register>),
            (0x30 => pub t_f_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TFReg::Register>),
            (0x34 => pub t_su_dat_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TSuDatReg::Register>),
            (0x38 => pub t_hd_dat_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::THdDatReg::Register>),
            (0x3c => pub t_high_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::THighReg::Register>),
            (0x40 => pub t_low_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TLowReg::Register>),
            (0x44 => pub t_hd_sta_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::THdStaReg::Register>),
            (0x48 => pub t_su_sta_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TSuStaReg::Register>),
            (0x4c => pub t_su_sto_reg: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::TSuStoReg::Register>),
            (0x50 => pub t_free_reg: tock_registers::registers::ReadOnly<u32>),
            (0x54 => pub t_aval_reg: tock_registers::registers::ReadOnly<u32>),
            (0x58 => pub t_idle_reg: tock_registers::registers::ReadOnly<u32>),
            (0x5c => _reserved10),
            (0x0 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
            (0x4 => pub controller_config: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ControllerConfig::Register>),
            (0x8 => @END),
        }
    }
}
