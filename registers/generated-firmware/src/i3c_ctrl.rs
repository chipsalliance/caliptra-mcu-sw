...
pub mod regs {
    ...
    register_structs! {
        pub I3cCtrl {
            ...
            (0x8c => _reserved4),
            (0x88 => pub rx_data_port: tock_registers::registers::ReadOnly<u32>),
            ...
            (0x104 => _reserved6),
            (0x100 => pub extcap_header: tock_registers::registers::ReadOnly<u32, crate::i3c_ctrl::bits::ExtcapHeader::Register>),
