...
impl<TMmio: ureg::Mmio> IntrBlockRfBlock<TMmio> {
    ...
    ///
    /// Read value: [`soc_ifc::regs::GlobalIntrEnTReadVal`]; Write value: [`soc_ifc::regs::GlobalIntrEnTWriteVal`]
    #[inline(always)]
    ...
    /// Nonsticky assertion.
    ///
    /// Read value: [`soc_ifc::regs::GlobalIntrTReadVal`]; Write value: [`soc_ifc::regs::GlobalIntrTWriteVal`]
    #[inline(always)]
    ...
    ///
    /// Read value: [`soc_ifc::regs::IntrCountIncrTReadVal`]; Write value: [`soc_ifc::regs::IntrCountIncrTWriteVal`]
    #[inline(always)]
...
pub mod regs {
    ...
    impl CptraSecurityStateReadVal {
        ...
        pub fn device_lifecycle(&self) -> super::enums::DeviceLifecycleE {
            super::enums::DeviceLifecycleE::try_from(self.0 & 3).unwrap()
        }
        /// Debug Locked
        #[inline(always)]
...
pub mod meta {
    ...
    pub type IntrBlockRfGlobalIntrEnR = ureg::ReadWriteReg32<
        0,
        crate::soc_ifc::regs::GlobalIntrEnTReadVal,
        crate::soc_ifc::regs::GlobalIntrEnTWriteVal,
    >;
    ...
    pub type IntrBlockRfErrorGlobalIntrR =
        ureg::ReadOnlyReg32<crate::soc_ifc::regs::GlobalIntrTReadVal>;
    ...
    pub type IntrBlockRfErrorInternalIntrCountIncrR =
        ureg::ReadOnlyReg32<crate::soc_ifc::regs::IntrCountIncrTReadVal>;
