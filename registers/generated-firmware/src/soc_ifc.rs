...
pub mod regs {
    ...
    register_structs! {
        pub SocIfc {
            ...
            (0x650 => _reserved4),
            (0x800 => pub global_intr_en_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::GlobalIntrEnT::Register>),
            (0x804 => pub error_intr_en_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::ErrorIntrEnT::Register>),
            (0x808 => pub notif_intr_en_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::NotifIntrEnT::Register>),
            ...
            (0x814 => pub error_internal_intr_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::ErrorIntrT::Register>),
            (0x818 => pub notif_internal_intr_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::NotifIntrT::Register>),
            (0x81c => pub error_intr_trig_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::ErrorIntrTrigT::Register>),
            (0x820 => pub notif_intr_trig_r: tock_registers::registers::ReadOnly<u32, crate::soc_ifc::bits::NotifIntrTrigT::Register>),
            (0x824 => _reserved5),
            (0x900 => pub error_internal_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x904 => pub error_inv_dev_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x908 => pub error_cmd_fail_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x90c => pub error_bad_fuse_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x910 => pub error_iccm_blocked_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x914 => pub error_mbox_ecc_unc_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x918 => pub error_wdt_timer1_timeout_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x91c => pub error_wdt_timer2_timeout_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x920 => _reserved6),
            (0x980 => pub notif_cmd_avail_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x984 => pub notif_mbox_ecc_cor_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x988 => pub notif_debug_locked_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x98c => pub notif_scan_mode_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x990 => pub notif_soc_req_lock_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x994 => pub notif_gen_in_toggle_intr_count_r: tock_registers::registers::ReadOnly<u32>),
            (0x998 => _reserved7),
