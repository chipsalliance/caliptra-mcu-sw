...
| 3    | `DOT`                | MCU ROM supports Device Ownership Transfer         |
| 4    | `OCP_LOCK`           | MCU ROM and device support OCP LOCK key management |
...
| 10   | `FW_MANIFEST_DOT`    | MCU ROM supports Device Ownership Transfer manifests |
| 11:31 | Reserved            | Responders report zero                              |
