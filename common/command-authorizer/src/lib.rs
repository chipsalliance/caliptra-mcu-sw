...
//!
//! The [`CommandAuthorizer`] trait abstracts MAC computation for authorized
...
/// A [`CommandAuthorizer`] that computes HMAC-SHA384.
///
...
impl CommandAuthorizer for HmacCommandAuthorizer {
    fn authorize(
        &self,
        cmd_id: u32,
        payload: &[u8],
