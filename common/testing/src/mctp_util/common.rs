...
// Default MCTP packet payload size: MCTP baseline transmission unit
const DEFAULT_PKT_PAYLOAD_SIZE: usize = 64;
...
mod tests {
    ...
    fn test_mctp_packetize_assembly() {
        ...
        assert!(verify_packetize_assembly(4096, 0, 245));
        assert!(verify_packetize_assembly(1000, 1, 245));
