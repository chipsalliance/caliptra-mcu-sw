...
mod test {
    ...
    fn test_check_update_component() {
        ...
        let comp = FirmwareComponent::new(
            ...
            0x01,
            0x12345680,
            PldmFirmwareString::new("ASCII", "mcu-runtime-1.2").unwrap(),
            None,
            None,
        );
        assert_eq!(
        ...
        let comp = FirmwareComponent::new(
            ...
            0x01,
            0x12345678,
            PldmFirmwareString::new("ASCII", "mcu-runtime-1.5").unwrap(),
            None,
            None,
        );
        assert_eq!(
        ...
        let comp = FirmwareComponent::new(
            ...
            0x01,
            0x12345680,
            PldmFirmwareString::new("ASCII", "mcu-runtime-0.5").unwrap(),
            None,
            None,
        );
        assert_eq!(
        ...
        let comp = FirmwareComponent::new(
            ...
            0x01,
            0x12345680,
            PldmFirmwareString::new("ASCII", "mcu-runtime-1.0").unwrap(),
            None,
            None,
        );
        assert_eq!(
