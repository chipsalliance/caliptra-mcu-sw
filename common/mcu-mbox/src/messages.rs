...
pub use caliptra_api::mailbox::{
    ...
    ManufDebugUnlockTokenReq, ProductionAuthDebugUnlockChallenge, ProductionAuthDebugUnlockReq,
...
impl CommandId {
    ...
    pub const MC_MANUF_DEBUG_UNLOCK_TOKEN: Self = Self(0x4D44_5554); // "MDUT"
...
pub enum McuMailboxReq {
    ...
    // Debug Unlock
    ManufDebugUnlockToken(McuManufDebugUnlockTokenReq),
...
impl McuMailboxReq {
    pub fn as_bytes(&self) -> McuMboxResult<&[u8]> {
        match self {
            ...
            McuMailboxReq::ManufDebugUnlockToken(req) => Ok(req.as_bytes()),
    ...
    pub fn as_mut_bytes(&mut self) -> McuMboxResult<&mut [u8]> {
        match self {
            ...
            McuMailboxReq::ManufDebugUnlockToken(req) => Ok(req.as_mut_bytes()),
    ...
    pub fn cmd_code(&self) -> CommandId {
        match self {
            ...
            McuMailboxReq::ManufDebugUnlockToken(_) => CommandId::MC_MANUF_DEBUG_UNLOCK_TOKEN,
...
pub enum McuMailboxResp {
    ...
    // Debug Unlock
    ManufDebugUnlockToken(McuManufDebugUnlockTokenResp),
...
impl McuMailboxResp {
    pub fn as_bytes(&self) -> McuMboxResult<&[u8]> {
        match self {
            ...
            McuMailboxResp::ManufDebugUnlockToken(resp) => Ok(resp.as_bytes()),
    ...
    pub fn as_mut_bytes(&mut self) -> McuMboxResult<&mut [u8]> {
        match self {
            ...
            McuMailboxResp::ManufDebugUnlockToken(resp) => Ok(resp.as_mut_bytes()),
...
#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, KnownLayout, Immutable, PartialEq, Eq)]
pub struct McuManufDebugUnlockTokenReq(pub ManufDebugUnlockTokenReq);
impl Request for McuManufDebugUnlockTokenReq {
    const ID: CommandId = CommandId::MC_MANUF_DEBUG_UNLOCK_TOKEN;
    type Resp = McuManufDebugUnlockTokenResp;
}

#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, KnownLayout, Immutable, PartialEq, Eq)]
pub struct McuManufDebugUnlockTokenResp(pub MailboxRespHeader);
impl Response for McuManufDebugUnlockTokenResp {}
