...
use mcu_mbox_common::messages::{
    CmDeleteReq, CmImportReq, CmKeyUsage, CmRandomGenerateReq, CmShaFinalReq, CmShaFinalResp,
    CmShaInitReq, CmShaUpdateReq, Cmk, DeviceCapsReq, DeviceCapsResp, DeviceIdReq, DeviceIdResp,
    DeviceInfoReq, DeviceInfoResp, FirmwareVersionReq, FirmwareVersionResp, MailboxReqHeader,
    MailboxRespHeader, MailboxRespHeaderVarSize, McuCmDeleteReq, McuCmImportReq, McuCmImportResp,
    McuCmStatusReq, McuCmStatusResp, McuMailboxReq, McuMailboxResp, McuRandomGenerateReq,
    McuShaFinalReq, McuShaFinalResp, McuShaInitReq, McuShaInitResp, McuShaUpdateReq,
    DEVICE_CAPS_SIZE, MAX_CMB_DATA_SIZE,
};
...
impl RequestResponseTest {
    ...
    // Removed duplicate import_key method
