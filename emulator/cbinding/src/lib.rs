...
pub struct CEmulatorConfig {
    ...
    pub allow_sideloaded_rom: c_uchar, // 0 = false, 1 = true (new)
    ...
    pub mcu_sram_sideload_offset: c_longlong,
    pub mcu_sram_sideload_size: c_longlong,
...
pub unsafe extern "C" fn emulator_init(
    ...
    let args = EmulatorArgs {
        ...
        mcu_sram_sideload_offset: convert_optional_offset_size(config.mcu_sram_sideload_offset),
        mcu_sram_sideload_size: convert_optional_offset_size(config.mcu_sram_sideload_size),
