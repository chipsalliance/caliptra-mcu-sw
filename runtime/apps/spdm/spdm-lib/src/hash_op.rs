...
/// Represents the interface for a cryptographic hash engine used in SPDM.
/// This trait provides methods for hashing data in a single step or in multiple steps
/// (start, update, and finish). It can be extended to async-trait if needed.
