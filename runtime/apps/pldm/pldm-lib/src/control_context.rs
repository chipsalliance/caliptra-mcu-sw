...
mod test {
    ...
    static CONTROL_CONTEXT: LazyLock<ControlContext> =
        LazyLock::new(|| ControlContext::new(&PLDM_PROTOCOL_CAPABILITIES));
    ...
    fn test_get_pldm_commands_responder() {
        ...
        // Test base protocol supported commands
        construct_request(
            &mut msg_buf,
        ...
        // Test get firmware update protocol supported commands
        construct_request(
            &mut msg_buf,
            GetPldmCommandsRequest::new(
                0x06,
    ...
    fn test_get_version_responder() {
        ...
        // Test get pldm version request with payload buffer too small
        msg_buf.fill(0);
    }
}
