...
/// Simple interface for reading, writing and erasing arbitrary length of data on flash storage. It is expected
/// that drivers for flash memory access  would implement this trait.
