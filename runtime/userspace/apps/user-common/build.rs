...
Abstract:
    ...
    Cargo build file for user-app-common shared crate.
...
fn write_fw_components_config() {
    ...
    // Ancestors: user-common -> apps -> userspace -> runtime -> <root>
    let workspace_root = manifest_dir
        .ancestors()
        .nth(4)
        .expect("Unable to determine workspace root from user-app-common path");
