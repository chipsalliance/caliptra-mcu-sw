...
use mcu_mbox_common::messages::{
    ...
    McuCmStatusReq, McuCmStatusResp, McuMailboxResp, McuRandomGenerateResp, McuShaFinalReq,
    ...
    async fn process_request(
        ...
        let result = match CommandId::from(cmd) {
            ...
            CommandId::MC_RANDOM_GENERATE => {
                ...
                self.handle_crypto_passthrough::<mcu_mbox_common::messages::McuRandomGenerateReq>(
                    msg_buf,
                    req_len,
