...
///
/// Unlike the `caliptra-api` `SignedEat`, this version only encodes COSE and
/// hashes the Sig_structure. Callers provide signatures generated by
/// Measurement API so DPE handle updates stay centralized.
pub struct SignedEatLite;

impl Default for SignedEatLite {
    fn default() -> Self {
        Self::new()
    }
}
