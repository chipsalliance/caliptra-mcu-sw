...
//!
//! Runtime cannot call ROM's private DOT derivation helper. It asks Caliptra to
//! derive an opaque CMK for the supplied context, then uses that CMK with the
//! existing HMAC API; root key material never enters MCU memory.
