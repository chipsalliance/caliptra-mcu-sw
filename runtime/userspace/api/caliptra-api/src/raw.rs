...
pub const CMD_ECDSA384_SIGNATURE_VERIFY: u32 = 0x4543_5632; // "ECV2"
pub const CMD_LMS_SIGNATURE_VERIFY: u32 = 0x4C4D_5632; // "LMV2"
...
pub const CMD_CM_DERIVE_STABLE_KEY: u32 = 0x494D_4453; // "CMDS"
