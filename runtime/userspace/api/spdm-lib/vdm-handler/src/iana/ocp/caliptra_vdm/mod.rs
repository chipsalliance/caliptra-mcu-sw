...
mod tests {
    ...
    use caliptra_mcu_common_commands::{
        DeviceCapabilities, EvidenceAlgorithm, EvidenceFormat, FirmwareVersion,
    };
    ...
    impl CaliptraCmdHandler for TestCommands {
        ...
        fn attestation_evidence_len(format: EvidenceFormat, algorithm: EvidenceAlgorithm) -> usize {
            match (format, algorithm) {
                (EvidenceFormat::PcrQuote, EvidenceAlgorithm::EccP384) => TEST_QUOTE_ECC_LEN,
                (EvidenceFormat::OcpEat, EvidenceAlgorithm::EccP384) => TEST_MAX_EVIDENCE_LEN,
                _ => 0,
            }
        }
    ...
    fn large_capacity_for_get_attestation_tracks_the_requested_format() {
        let quote = get_attestation_req(
            EvidenceFormat::PcrQuote as u32,
            EvidenceAlgorithm::EccP384 as u32,
        );
        assert_eq!(
        ...
        for req in [
            ...
            get_attestation_req(0xDEAD_BEEF, EvidenceAlgorithm::EccP384 as u32),
            vec![
                CALIPTRA_VDM_COMMAND_VERSION,
                CaliptraVdmCommand::GetAttestation as u8,
            ],
    ...
    fn get_attestation_rejects_unsupported_and_malformed_requests() {
        ...
        let cases = [
            ...
            (
                get_attestation_req(0x99, EvidenceAlgorithm::EccP384 as u32),
