...
impl BitmapAllocator {
    ...
    /// RAII: [`BitmapBytes`] and [`McuSpdmBox`] release their slots on drop,
...
mod tests {
    ...
    /// able to hand out the declared `MAX_SPDM_MSG_SIZE` (7 KiB) large buffer
    ...
    ///   * large buffer    = `MAX_SPDM_MSG_SIZE`      =  7 KiB
    ...
    fn declared_max_spdm_msg_size_is_allocatable_from_shipping_pool() {
        ...
        const MAX_SPDM_MSG_SIZE: usize = 7 * 1024;
