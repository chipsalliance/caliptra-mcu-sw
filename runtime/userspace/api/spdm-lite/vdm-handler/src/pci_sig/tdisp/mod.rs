...
//!
//! This module ports the spdm-lib TDISP command set using static dispatch,
//! no boxed futures, no heap-backed handler tables, and no spdm-lib wire types. Request
//! decoding and response generation intentionally follow spdm-lib's validation
//! order and error responses command-by-command.
...
pub use driver::EmulatedTdispDriver;
