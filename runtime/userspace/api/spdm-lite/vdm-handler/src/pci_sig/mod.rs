...
mod tests {
    ...
    use crate::pci_sig::tdisp::{
        EmulatedTdispDriver, TdispCommand, TdispErrorCode, TdispResponder, TdispVersion,
        TDISP_ERROR_INVALID_INTERFACE_STATE, TDISP_ERROR_INVALID_REQUEST, TDISP_VERSION_1_0,
    };
    ...
    fn backend() -> PciSigTdispVdm<EmulatedTdispDriver> {
        PciSigTdispVdm::new(
            TEST_VENDOR_ID,
    ...
    fn dispatch(
        backend: &PciSigTdispVdm<EmulatedTdispDriver>,
        req: &[u8],
        inline_len: usize,
