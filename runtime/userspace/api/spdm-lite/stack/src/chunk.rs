...
use crate::vendor_defined::{self, SpdmVdmBackend};
    ...
    Vdm: SpdmVdmBackend,
{
    ...
    let max_response_len = effective_data_transfer_size(state, pal).saturating_sub(ack_body_len);
...
{
    let large_req = pal
        .large_message(state.chunk.large_msg_size as usize)
