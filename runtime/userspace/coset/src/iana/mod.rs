...
iana_registry! {
    ...
    CwtClaimName {
        ...
        Ueid: 256,
        /// Hardware OEM ID ("oemid": int or bstr)
        Oemid: 258,
        /// Hardware Model ("hwmodel": bstr)
        Hwmodel: 259,
        /// Uptime of the device ("uptime": uint)
        Uptime: 261,
        /// Debug Status ("dbgstat": uint)
        Dbgstat: 263,
        /// EAT Profile ("eat_profile": uri or oid)
        EatProfile: 265,
        /// Boot Count ("bootcount": uint)
        Bootcount: 267,
        /// Boot Seed ("bootseed": bstr)
        Bootseed: 268,
        /// DLOAs: Certifications received as Digital Letters of Approval ("dloas": array)
        Dloas: 269,
        /// Measurements of the sw, memory config, and such on the entity("measurements": array)
        Measurements: 273,
    }
}
