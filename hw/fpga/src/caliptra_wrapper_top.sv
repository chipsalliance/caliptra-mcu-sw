...
mcu_rom (
    ...
    */
    ...
    always_comb begin
        ...
        2'b00:   SCL = 1'b0; //  AXI_I3C | pullup 1, output disable, data 0
        2'b01:   SCL = 1'b0; //  AXI_I3C | pullup 1, output disable, data 1
        2'b10:   SCL = 1'b0; //  AXI_I3C | pullup 1, output enable,  data 0
        2'b11:   SCL = 1'b1; //  AXI_I3C | pullup 1, output enable,  data 1
    ...
    i3c_wrapper #(
        ...
        // Interrupts
        .irq_o                          (hwif_in.interface_regs.spare_i3c_control_sts.irq_o.next),
