...
pub use zerocopy::{AsBytes as ZeroCopyAsBytes, FromBytes as ZeroCopyFromBytes, FromZeroes as ZeroCopyFromZeroes};
...
pub trait CommandResponse: AsBytes + FromBytes + Sized {
