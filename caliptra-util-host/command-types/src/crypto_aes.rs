...
/// Maximum data size per command (matches MCU mailbox SRAM limit)
pub const MAX_AES_DATA_SIZE: usize = 4096;

/// AES context size for CBC/CTR modes (encrypted server state)
pub const AES_CONTEXT_SIZE: usize = 156;

/// AES-GCM context size
pub const AES_GCM_CONTEXT_SIZE: usize = 128;

/// AES IV size (16 bytes for CBC/CTR)
...
/// Maximum GCM output size (data + tag)
...
// ============================================================================
// AES Encrypt Init (MC_AES_ENCRYPT_INIT)
// ============================================================================

/// AES Encrypt Init request
#[repr(C)]
...
// ============================================================================
// AES Encrypt Update (MC_AES_ENCRYPT_UPDATE)
// ============================================================================

/// AES Encrypt Update request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES Decrypt Init (MC_AES_DECRYPT_INIT)
// ============================================================================

/// AES Decrypt Init request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES Decrypt Update (MC_AES_DECRYPT_UPDATE)
// ============================================================================

/// AES Decrypt Update request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Encrypt Init (MC_AES_GCM_ENCRYPT_INIT)
// ============================================================================

/// AES-GCM Encrypt Init request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Encrypt Update (MC_AES_GCM_ENCRYPT_UPDATE)
// ============================================================================

/// AES-GCM Encrypt Update request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// AES-GCM Encrypt Update response
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Encrypt Final (MC_AES_GCM_ENCRYPT_FINAL)
// ============================================================================

/// AES-GCM Encrypt Final request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// AES-GCM Encrypt Final response
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Decrypt Init (MC_AES_GCM_DECRYPT_INIT)
// ============================================================================

/// AES-GCM Decrypt Init request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Decrypt Update (MC_AES_GCM_DECRYPT_UPDATE)
// ============================================================================

/// AES-GCM Decrypt Update request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// AES-GCM Decrypt Update response
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
// ============================================================================
// AES-GCM Decrypt Final (MC_AES_GCM_DECRYPT_FINAL)
// ============================================================================

/// AES-GCM Decrypt Final request
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// AES-GCM Decrypt Final response
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
