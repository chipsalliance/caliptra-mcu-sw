...
// External mailbox command codes
pub const MC_AES_ENCRYPT_INIT: u32 = 0x4D43_4349; // "MCCI"
pub const MC_AES_ENCRYPT_UPDATE: u32 = 0x4D43_4355; // "MCCU"
pub const MC_AES_DECRYPT_INIT: u32 = 0x4D43_414A; // "MCAJ"
pub const MC_AES_DECRYPT_UPDATE: u32 = 0x4D43_4155; // "MCAU"
pub const MC_AES_GCM_ENCRYPT_INIT: u32 = 0x4D43_4749; // "MCGI"
pub const MC_AES_GCM_ENCRYPT_UPDATE: u32 = 0x4D43_4755; // "MCGU"
pub const MC_AES_GCM_ENCRYPT_FINAL: u32 = 0x4D43_4746; // "MCGF"
pub const MC_AES_GCM_DECRYPT_INIT: u32 = 0x4D43_4449; // "MCDI"
pub const MC_AES_GCM_DECRYPT_UPDATE: u32 = 0x4D43_4455; // "MCDU"
pub const MC_AES_GCM_DECRYPT_FINAL: u32 = 0x4D43_4446; // "MCDF"

// ============================================================================
// AES Encrypt Init Command
// ============================================================================

/// External AES Encrypt Init request format
#[repr(C)]
...
/// External AES Encrypt Init response format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
impl FromInternalRequest<AesEncryptInitRequest> for ExtCmdAesEncryptInitRequest {
    fn from_internal(internal: &AesEncryptInitRequest, command_code: u32) -> Self {
        ...
        let len = internal.plaintext_size as usize;
...
impl FromInternalRequest<AesDecryptInitRequest> for ExtCmdAesDecryptInitRequest {
    fn from_internal(internal: &AesDecryptInitRequest, command_code: u32) -> Self {
        ...
        let len = internal.ciphertext_size as usize;
