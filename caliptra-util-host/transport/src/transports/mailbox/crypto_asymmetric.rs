...
pub const MC_ECDSA_CMK_PUBLIC_KEY: u32 = 0x4D43_4550; // "MCEP"
pub const MC_ECDSA_CMK_SIGN: u32 = 0x4D43_4553; // "MCES"
pub const MC_ECDSA_CMK_VERIFY: u32 = 0x4D43_4556; // "MCEV"
pub const MC_ECDH_GENERATE: u32 = 0x4D43_4547; // "MCEG"
pub const MC_ECDH_FINISH: u32 = 0x4D43_4546; // "MCEF"

// ============================================================================
// ECDSA Public Key Command
// ============================================================================

/// External ECDSA public key request format
#[repr(C)]
...
/// External ECDSA public key response format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDSA sign request format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDSA sign response format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDSA verify request format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDH generate request format
#[repr(C)]
#[derive(Debug, Clone, Default, IntoBytes, FromBytes, Immutable)]
...
/// External ECDH generate response format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDH finish request format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
...
/// External ECDH finish response format
#[repr(C)]
#[derive(Debug, Clone, IntoBytes, FromBytes, Immutable)]
