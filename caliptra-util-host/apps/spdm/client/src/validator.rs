...
pub fn run_all(
    ...
    fe_prog_authorizer: Option<&dyn CommandAuthorizer>,
    verbose: bool,
...
///
/// When a [`CommandAuthorizer`] is provided, performs the full authorized flow:
...
pub fn run_fe_prog(
    client: &mut SpdmVdmClient,
    partition: u32,
    authorizer: Option<&dyn CommandAuthorizer>,
    verbose: bool,
) -> ValidationResult {
