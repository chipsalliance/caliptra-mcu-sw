...
Abstract:
    ...
    This driver implements the network_hil::Ethernet trait using the
    auto-generated register definitions from registers-generated.
...
/// Ethernet driver for the Network Coprocessor
///
/// This driver provides access to the Ethernet peripheral through
...
impl EthernetDriver {
    ...
    /// Write a word to the TX data buffer at the given index
    fn write_tx_data(&mut self, index: usize, value: u32) {
        self.regs.eth_tx_data[index].set(value);
    }

    /// Read a word from the RX data buffer at the given index
